...
const { localUpload } = require("../middleware/upload.js");
const { startChat, getOrCreateChat, getChatMessages, getMyChats, uploadImage } = require("../controller/chat.controller.js");
...
router.post("/upload-image", authMiddleware, localUpload.single("image"), uploadImage);
